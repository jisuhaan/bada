...
public class Bada_list_DTO {
	...
	public Bada_list_DTO(String beach, String state, String address, int latitude, int longitude, int grid_x,
			int gride_y, String beachNum, String baseDate, String baseTime, String pop, String pty, String pcp,
