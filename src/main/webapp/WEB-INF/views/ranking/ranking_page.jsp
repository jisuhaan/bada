    ...
    <div class="ranking-list best3">
    	...
    	<div id="rank_title">후기 단골 맛집 바다는</div>
    		...
    		<div class="mostreviewed no2">
    			...
    			<div class="awardtitle best3title">${reviewCountlist[1].beach}</div>
    		</div>
    	...
    	<div id="rank_title">별이 많이 뜬 바다는</div>
    		...
    		<div class="bestscored no2">
    			...
    			<div class="awardtitle best3title">${reviewScorelist[1].beach}</div>
    		</div>
    	...
    	<div id="rank_title">또 가고 싶은 바다는</div>
    		...
    		<div class="revisit_no2">
    			...
    			<div class="awardtitle best3title">${re_visitlist[1].beach}</div>
    		</div>
